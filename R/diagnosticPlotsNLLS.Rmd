...
if (!validation){ 
  ...
  ##################################################
  create_diagnosticPlotList()$p1$plotFunc(eval(parse(text = paste0("named.list(",create_diagnosticPlotList()$p1$plotParams,")"))))
...
```{r, eval=TRUE, echo=FALSE,warning=FALSE, message = FALSE,fig.height=8, fig.width=8}  
  ...
  create_diagnosticPlotList()$p2$plotFunc(eval(parse(text = paste0("named.list(",create_diagnosticPlotList()$p2$plotParams,")"))))
...
```{r, eval=TRUE, echo=FALSE,warning=FALSE, message = FALSE, out.width="750px", out.height="750px"}  
  create_diagnosticPlotList()$p3$plotFunc(eval(parse(text = paste0("named.list(",create_diagnosticPlotList()$p3$plotParams,")"))))
# if (!validation){ 
#   
#   markerText<-"~paste('</br> Squared Log Residual: ',Resids2,
#                    '</br> Predicted Load: ',predict"
...
```{r, eval=TRUE, echo=FALSE,warning=FALSE, message = FALSE, out.width="750px", out.height="750px"}    
  create_diagnosticPlotList()$p5$plotFunc(eval(parse(text = paste0("named.list(",create_diagnosticPlotList()$p5$plotParams,")"))))
...
##################################################  
  create_diagnosticPlotList()$p9$plotFunc(eval(parse(text = paste0("named.list(",create_diagnosticPlotList()$p9$plotParams,")"))))
...
##################################  
  create_diagnosticPlotList()$p10$plotFunc(eval(parse(text = paste0("named.list(",create_diagnosticPlotList()$p10$plotParams,")"))))
...
plotParams<-eval(parse(text = paste0("named.list(",create_diagnosticPlotList()$p12$plotParams,")")))
