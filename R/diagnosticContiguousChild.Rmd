...
i <- {{i}}
if (simulation){
    plotParams<-eval(parse(text = paste0("named.list(",create_diagnosticPlotList()$p8$plotParams,")")))
...
#create_diagnosticPlotList()$p8$plotFunc(eval(parse(text = paste0("named.list(",create_diagnosticPlotList()$p8$plotParams,")"))))
