#'@title dropFunc
#'@description Shiny ui function creates drop down button with SelectAll and ClearAll Buttons and 
#'a multi-select list of variables in the designated category.  Only applied in Batch mode.
#'@param id Shiny namespace designation
#'@param input Shiny input selections
#'@param category variable type from unique(choices$category)
